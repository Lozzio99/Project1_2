...
import static phase3.Math.ADT.Point.ORIGIN;
...
public class Plot extends Canvas {
    ...
    private phase3.Math.ADT.Point[] p1, p2, p3;
    ...
    public Plot() {
        ...
        phase3.Math.ADT.Point.setScreen(screen);
        ORIGIN = new phase3.Math.ADT.Point();
    ...
    public static double[] linXSorted(double[] sortedX, int n) {
    ...
    public Plot plot(double[] xs, double[] ys) {
        ...
        this.p1 = new phase3.Math.ADT.Point[xs.length];
        for (int i = 0; i < this.p1.length; i++) {
            this.p1[i] = new phase3.Math.ADT.Point(x[i], y[i]);
        }
        this.f1 = y;
        plot1 = true;
        calculated = true;
    ...
    public Plot plot2(double[] xs, double[] ys) {
        ...
        y = Arrays.copyOf(ys, ys.length);
        sortingForDrawing(x, y);
        this.p2 = new phase3.Math.ADT.Point[xs.length];
        for (int i = 0; i < this.p2.length; i++) {
            this.p2[i] = new phase3.Math.ADT.Point(x[i], y[i]);
        }
        calculated = true;
        return this.start();
    }
    ...
    public Plot plot3(double[] xs, double[] ys) {
        ...
        y = Arrays.copyOf(ys, ys.length);
        sortingForDrawing(x, y);
        this.p3 = new phase3.Math.ADT.Point[xs.length];
        for (int i = 0; i < this.p3.length; i++) {
            this.p3[i] = new phase3.Math.ADT.Point(x[i], y[i]);
        }
        calculated = true;
        return this.start();
    }
    ...
    private void axis() {
        phase3.Math.ADT.Point px = new phase3.Math.ADT.Point(-400, 0), py = new phase3.Math.ADT.Point(0, -400), px1 = new phase3.Math.ADT.Point(400, 0), py1 = new phase3.Math.ADT.Point(0, 400);
