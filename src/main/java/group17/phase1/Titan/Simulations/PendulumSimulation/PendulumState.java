...
public class PendulumState implements StateInterface {
    ...
    public StateInterface state0() {
        ...
        this.rate.getVelocities().add(new Vector3D(0, v1, 0));
        this.rate.getVelocities().add(new Vector3D(0, v2, 0));
        return this;
    }
    ...
    public StateInterface addMul(double step, RateInterface rate) {
        ...
        for (int i = 0; i < this.getPositions().size(); i++) {
            ...
            newState.getRateOfChange().getVelocities().add(this.getPositions().get(i));
        }
        return newState;
    }
}
