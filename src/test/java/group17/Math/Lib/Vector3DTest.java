...
class Vector3DTest {
    ...
    void Constructor() {
        ...
        Vector3dInterface v2 = new Vector3D(new Point3D(0, 0, 0));
        Vector3dInterface v3 = new Vector3D(new Point3D(1, -3, 1), new Point3D(1, -3, 1));
        assertAll(
                () -> assertEquals(v, v1),
                () -> assertEquals(v1, v2),
                () -> assertEquals(v2, v3)
    ...
    @Test
    @DisplayName("FromVector")
    void FromVector() {
        Vector3dInterface a = new Vector3D(-1.1, 0.1, 1.1);
        Point3D b = a.fromVector();
        assertEquals(-1.1, b.getXCoordinate());
        assertEquals(0.1, b.getYCoordinate());
        assertEquals(1.1, b.getZCoordinate());
    }
    ...
    void Heading() {
        Vector3dInterface test = new Vector3D(1.1, 1.0, -1.0);
        assertTrue(() -> abs(0.7378150601204649 - test.heading()) < 1e-8);
    }
